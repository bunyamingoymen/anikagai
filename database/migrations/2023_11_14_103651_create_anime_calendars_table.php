...
return new class extends Migration
{
    ...
    {
        Schema::create('anime_calendars', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer("special_type")->nullable(); //1: günlük, 2: haftalık, 3: aylık, 4: yıllık, 5:özel
    ...
    {
        Schema::dropIfExists('anime_calendars');
    }
};
