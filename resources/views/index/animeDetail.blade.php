                        ...
                        <div class="banner-meta">
                            <ul>
                                ...
                                <li class="release-time">
                                    ...
                                    <span><i class="far fa-clock"></i>48 Bölüm</span>
                                </li>
                            </ul>
                        </div>
                        <p>Tokyo Gûl, Sui Ishida tarafından yazılan bir manga serisidir. Seri, Eylül 2011-2014 tarihleri
                            arasonda Shueisha'nin
                            Weekly Young Jump dergisinde 14 tankōbon cilt halinde yayınlandı. Tokyo Ghoul [Jack] adlı
                            bir önbölüm serisi
                            Ağustos-Eylül 2013 tarihleri arasında Jump Live uygulamasında çevrimiçi olarak yayınlandı.
                        </p>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="movie-item mb-50">
                        <div class="movie-poster">
                            <a href="movie-details.html"><img src="../../../user/img/poster/s_ucm_poster01.jpg" alt=""
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="movie-item mb-50">
                        <div class="movie-poster">
                            <a href="movie-details.html"><img src="../../../user/img/poster/s_ucm_poster02.jpg" alt=""
                                    style="min-width: 303px; min-height: 430px; max-width: 303px; max-height: 430px;"></a>
                        </div>
                        <div class="movie-content">
                            <div class="top">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="movie-item mb-50">
                        <div class="movie-poster">
                            <a href="movie-details.html"><img src="../../../user/img/poster/s_ucm_poster03.jpg" alt=""
                                    style="min-width: 303px; min-height: 430px; max-width: 303px; max-height: 430px;"></a>
                        </div>
                        <div class="movie-content">
                            <div class="top">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="movie-item mb-50">
                        <div class="movie-poster">
                            <a href="movie-details.html"><img src="../../../user/img/poster/s_ucm_poster04.jpg" alt=""
                                    style="min-width: 303px; min-height: 430px; max-width: 303px; max-height: 430px;"></a>
                        </div>
                        <div class="movie-content">
                            <div class="top">
