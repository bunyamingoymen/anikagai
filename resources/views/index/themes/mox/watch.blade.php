                    ...
                    <div class="col-xl-12">
                        <div class="contact-form-wrap">
                            <div class="widget-title mb-50">
                                <h5 class="title">{{ $anime->name }} <span style="color:#e53637"
                                        {{ $anime->plusEighteen == '0' ? 'hidden' : '' }}>+18</span>
                                </h5>
                            </div>
                            <div class="anime__video__player justify-content-center">
                                ...
                                @if ($next_episode_url != 'none')
                                    <button id="nextEpisodeButton" class="overlay-button" style="display:none;"
                                        hidden>Sonraki
                                        bölüme
                                        geç</button>
                                @endif
