                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            <h2 class="title"><span>{{ $title }} <span id="mainTitleID" style="color:red;"></span>
                                </span>
                            </h2>
                    ...
                    <div class="col-12">
                        <div class="pagination-wrap mt-30">
                            <nav>
                                <ul>
                                    @if ($currentPage != 1)
                                        <li><a href="javascript:;" onclick=" changePage({{ $currentPage - 1 }})">Geri</a>
                                        </li>
                                    @endif
                                    ...
                                    @if ($currentPage != $pageCount)
                                        <li><a href=" javascript:;"
                                                onclick=" changePage({{ $currentPage + 1 }})">İleri</a>
                                        </li>
                                    @endif
                                </ul>
                            </nav>
