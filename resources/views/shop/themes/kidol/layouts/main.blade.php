...
<head>
    ...
    <title>Home 01 - Kidol - Kids Toys Store eCommerce HTML Template</title>
          ...
          <div class="cart-content cart-content-padding">
            <ul>
              <li class="single-product-cart">
                <div class="cart-img">
                  <a href="shop-single-product.html"><img src="{{url('shop_files/assets/img/shop/details/nav1.jpg')}}" alt=""></a>
                </div>
              ...
              <li class="single-product-cart">
                <div class="cart-img">
                  <a href="shop-single-product.html"><img src="{{url('shop_files/assets/img/shop/details/nav2.jpg')}}" alt=""></a>
                </div>
                <div class="cart-title">
