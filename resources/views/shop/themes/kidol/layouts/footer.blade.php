                    ...
                    <div class="widget-item item-style3">
                        <div class="about-widget">
                            <a class="footer-logo" href="index.html">
                                <img src="{{ url('shop_files/assets/img/logo.png') }}" alt="Logo">
                            </a>
                            <p>Lorem ipsum dolor sit amet, consecl adipisicing elit, sed do eiusmod teml incididunt ut
                            ...
                            <div class="widget-payment-info">
                                <div class="thumb">
                                    <a href="index.html"><img
                                            src="{{ url('shop_files/assets/img/photos/payment1.png') }}"
                                            alt="Image"></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row text-center">
                    <div class="col-sm-12">
                        <div class="widget-copyright">
                            <p><i class="fa fa-copyright"></i> 2024 <span>Anikagai Shop. </span> Made with <i
                                    class="fa fa-heart"></i> by <a target="_blank"
                                    href="{{ env('APP_URL') }}">Anikagai</a></p>
                        </div>
                    </div>
                </div>
            </div>
