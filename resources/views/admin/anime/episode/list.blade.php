            ...
            success: function(animes) {
                ...
                for(let i = 0; i<animes.length; i++){
                    code += `<tr>
                            ...
                            <td>
                                <img class="rounded-circle header-profile-user" src="../../../`+animes[i].anime_image+`" alt="`+animes[i].anime_name+`">
                                </td>
    ...
    function deleteAnimeEpisde(code){
        ...
        /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
                var html = `<form action='{{route('admin_anime_episodes_delete')}}' method="POST" id="deleteAnimeEpisdeForm"> @csrf`;
