                ...
                <div class="mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="ml-5">
                            ...
                            <div hidden>
                                <form action="{{route('admin_data_logo')}}" method="POST" id="logoChangeSubmitForm"
                        ...
                        <div class="ml-5">
                            ...
                            <div hidden>
                                <form action="{{route('admin_data_logo')}}" method="POST"
                                    ...
                                    @csrf
                                    <input type="file" name="logo_footer" id="logoFooterChangeInput" accept="image/*">
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-5">
                    ...
                    <div class="row">
                        ...
                        <div class="ml-5">
                            ...
                            <div hidden>
                                <form action="{{route('admin_data_logo')}}" method="POST" id="iconChangeSubmitForm"
                                    enctype="multipart/form-data">
                                    @csrf
