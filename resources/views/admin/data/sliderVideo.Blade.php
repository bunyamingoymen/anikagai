                            ...
                            <form class="needs-validation" id="sliderVideo{{ $item->code }}" action="" method="POST"
                                    ...
                                    <div class="col-md-12 mb-3 mt-4">
                                        ...
                                        <div class="progress" style="height: 15px;">
                                            <div class="progress-bar progress-bar-striped bg-danger progress-bar-animated"
                                                role="progressbar" id="progress-bar-video{{ $item->code }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="file" class="form-control" id="video{{ $item->code }}"
                                            name="video" placeholder="Dosya Seçiniz" accept="video/*" required>
                                    </div>
                                </div>
                                <div style="">
                        ...
                        xhr: function() {
                            ...
                            xhr.upload.addEventListener('progress', function(e) {
                                if (e.lengthComputable) {
                                    ...
                                    document.getElementById('percentValue' + slider_video_code).innerText =
                                        parseInt(percent) + "%"
                                    document.getElementById('progress-bar-video' + slider_video_code).style
                                        .width = percent + "%"

                                    document.getElementById('progress-bar-video' + slider_video_code)
