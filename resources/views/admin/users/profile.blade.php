                        ...
                        <div class="text-center card-box shadow-none border border-secoundary">
                            <div class="member-card">
                                ...
                                @else
                                    @if ($followed == 1)
                                        <button type="button"
                                            class="btn btn-danger btn-sm width-sm waves-effect mt-2 waves-light"
                                            onclick="unfollowUser()">Takipten
                                            Çıkar</button>
                                    @else
                                        <button type="button"
                                            class="btn btn-success btn-sm width-sm waves-effect mt-2 waves-light"
                                    ...
                                    <button type="button"
                                        class="btn btn-info btn-sm width-sm waves-effect mt-2 waves-light"
                                ...
                                <ul class="social-links list-inline mt-4">
                                    @if (isset($user->facebook))
                                        <li class="list-inline-item">
                                            <a title="" data-placement="top" data-toggle="tooltip"
                                                class="btn btn-light" href="{{ $user->facebook }}"
                                    ...
                                    @if (isset($user->twitter))
                                        <li class="list-inline-item">
                                            <a title="" data-placement="top" data-toggle="tooltip"
                                                class="btn btn-light" href="{{ $user->twitter }}"
                                    ...
                                    @if (isset($user->instagram))
                                        <li class="list-inline-item">
                                            <a title="" data-placement="top" data-toggle="tooltip"
                                                class="btn btn-light" href="{{ $user->instagram }}"
                                    ...
                                    @if (isset($user->discord))
                                        <li class="list-inline-item">
                                            <a title="" data-placement="top" data-toggle="tooltip"
                                                class="btn btn-light" href="{{ $user->discord }}"
                                                data-original-title="Discord"><i class="fab fa-discord"></i></a>
                                        </li>
                                    @endif
                                </ul>
                                ...
                                @if (count($anime_episodes) > 0)
                                    @foreach ($anime_episodes as $item)
                                        <div class="pt-2">
                                            ...
                                            <p class="mb-0">{{ $item->episode_short }}.Bölüm
                                                {{ $item->season_short }}.Sezon</p>
