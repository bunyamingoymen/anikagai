                        ...
                        <form class="needs-validation" id="userUpdateForm" action="{{ route('admin_user_update') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="İsim" value="{{ $user->name }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="surname">Soyisim:</label>
                                    <input type="text" class="form-control" id="surname" name="surname"
                                        placeholder="Soyisim" value="{{ $user->surname }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" cols="30" rows="10" placeholder="Açıklama">{{ $user->description }}</textarea>
                                </div>
                            </div>
                            @if (Auth::guard('admin')->user()->code == $user->code || $update == 1)
                                <div class="row">
