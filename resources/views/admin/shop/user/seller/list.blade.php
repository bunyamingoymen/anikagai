...
@section('admin_content')
    @if ($list)
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="ag-theme-quartz mt-2 mb-2" style="height: 500px;" id="myGrid2"></div>
        ...
        <!--2.tablo için Sayfa Değiştirme Scripti-->
        <script>
            function changePage2(page2) {
                var pageData = {
                    page: page2,
                }
                if (showingCount1 && showingCount1 != 10) {
                    pageData.showingCount = showingCount1;
                }
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (let i = 0; i < items.length; i++) {
                            ...
                            rowData2.push(rowItem2);
                        }

                        getOtherData2(page_count, page2);
            ...
            function clickFirstTable(event) {
                console.log(event.data); // Tıklanan sütundaki tüm verileri getirir
                console.log(event.data.id); // Tıklanan sütundaki id'yi getirir
                console.log(event.data.code); //Tıklanan sütundaki code'u getirir
            }
        </script>

        <!--Ag-gird Komutları 2.tablo için-->
        <script>
            var columnDefs2 = [{
                    headerName: "#",
                    field: "id",
