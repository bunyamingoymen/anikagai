                    ...
                    code += `<tr>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">`
                                        @if ($delete == 1)
                                            code += `<a class="dropdown-item" href="javascript:;" onclick="deleteIndexUser(`+indexUsers[i].code+`)">Sil</a>`
                                        @endif
                                        @if ($update == 1)
                                        code += `<a class="dropdown-item" href="{{route('admin_indexuser_update_screen')}}?code=`+indexUsers[i].code+`">Güncelle</a>`
                                        @endif
        ...
        @if ($delete == 1)
            ...
            /* Read more about isConfirmed, isDenied below */
                if (result.isConfirmed) {
                    var html = `<form action='{{route("admin_indexuser_delete")}}' method="POST" id="deleteIndexUserForm"> @csrf`;
