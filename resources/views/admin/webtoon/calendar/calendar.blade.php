...
@section('admin_content')
    @if ($list == 1)
        ...
        <script>
            ...
            addEventsRepeats(repeat_type, interval, start_date, end_date, webtoon_name, backgroundColor, webtoon_code); @endforeach

            }

            function addEventsRepeats(repeat_type, interval, start_date, end_date, webtoon_name, backgroundColor,
            webtoon_code) {
