                        ...
                        <form class="needs-validation" id="webtoonUpdateForm" action="{{ route('admin_webtoon_update') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="İsim" value="{{ $webtoon->name }}" required>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="date" name="date"
                                        placeholder="Örn: 2015" value="{{ $webtoon->date }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <textarea class="form-control" name="description" id="description" cols="30" rows="15" placeholder="Açıklama">{{ $webtoon->description }}</textarea>
                                </div>
                                <div class=" col-md-4 mb-3">
                                    <div>
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <select class="form-control js-seelct-multiple" name="main_category" id="main_category">
                                        ...
                                        @foreach ($categories as $category)
                                            @if ($webtoon->main_category == $category->code)
                            ...
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <select name="showStatus" id="" class="form-control">
                                        <option value="0" {{ $webtoon->showStatus == 0 ? 'selected' : '' }}>Herkes
                                            görebilir
                                        </option>
                                        <option value="1" {{ $webtoon->showStatus == 1 ? 'selected' : '' }}>Üye
                                            olanlar görebilir.
                                            Üye
                                            olmayanlar hiçbir şekilde göremez.</option>
                                        <option value="2" {{ $webtoon->showStatus == 2 ? 'selected' : '' }}>Üye
                                            olanlar görebilir.
                                            Üye
                                            olmayanlar sansürlü bir şekilde görebilir.
                                        </option>
                                        <option value="3" {{ $webtoon->showStatus == 3 ? 'selected' : '' }}>Sadece
                                            Link Üzerinden
                                            Erişilebilir.Listelemede çıkmaz.</option>
                                        <option value="4" {{ $webtoon->showStatus == 4 ? 'selected' : '' }}>Hiçkimse
                                            Göremez.Gizlidir.
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 ">
                                    <input type="checkbox" id="plusEighteen" name="plusEighteen"
                                        {{ $webtoon->plusEighteen == 1 ? 'checked' : '' }}>
