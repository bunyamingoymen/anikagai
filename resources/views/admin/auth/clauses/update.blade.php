...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Yetki Maddesini Güncelle</h4>
                <p class="card-title-desc">
                    Aşağıda bulunan yetki maddesini, istediğiniz gibi değiştirebilirsiniz.
                </p>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" name="description" id="description" cols="30" rows="10"
                                placeholder="Açıklama">{{$clause->description}}</textarea>
