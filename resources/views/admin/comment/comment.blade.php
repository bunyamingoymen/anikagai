                    ...
                    code += `<tr>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">`
                                        @if ($delete == 1)
                                            code += `<a class="dropdown-item" href="javascript:;" onclick="deleteComment(`+comments[i].code+`)">Sil</a>`
                                        @endif
                            code += `</div>
                                </div>
                            </td>
    ...
    function deleteComment(code){
        ...
        /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
                var html = `<form action='{{route('admin_comment_delete')}}' method="POST" id="deleteCommentForm"> @csrf`;
